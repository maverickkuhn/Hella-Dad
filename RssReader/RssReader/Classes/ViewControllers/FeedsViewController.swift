...
class FeedsViewController: UITableViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        switch ConfigurationManager.defaultTheme() {
            case "dark":
                refreshControl?.backgroundColor = UIColor(red:254.0/255.0, green:91.0/255.0, blue:0.0/255.0, alpha:1.0)
...
//                let destinationViewController:DetailArticleTableViewController = segue.destinationViewController as! DetailArticleTableViewController
